      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600">
              {favoriteProducts.length} товар{favoriteProducts.length === 1 ? '' : favoriteProducts.length > 4 ? 'ов' : 'а'} в избранном
            </p>
          </div>
        </div>
        ...
        {favoriteProducts.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Пока нет избранных товаров</h2>
            <p className="text-gray-600 mb-8">
              Начните просматривать товары и добавляйте понравившиеся в избранное
            </p>
            <Link href="/">
              <Button>
                Продолжить покупки
              ...
              return (
                <div key={product.id} className="bg-white rounded-lg shadow-sm border hover:shadow-md transition-all duration-300 group h-full flex flex-col">
                  ...
                  <div className="p-4 sm:p-5 flex flex-col flex-grow">
                    <p className="text-xs sm:text-sm text-gray-500 mb-2">Магазин продавца</p>
                    ...
                    <div className="space-y-2 mb-4 mt-auto">
                      ...
                      <p className="text-xs text-green-600">Бесплатная доставка</p>
                    </div>
