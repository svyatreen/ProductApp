    ...
    <main>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Откройте для себя удивительные товары от проверенных продавцов
              </h2>
              <p className="text-xl mb-8 text-blue-100">
                Присоединяйтесь к тысячам продавцов и миллионам покупателей на нашей процветающей площадке
              </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900">Рекомендуемые товары</h3>
            <Link href="/products">
      ...
      <section className="py-16 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Присоединяйтесь к тысячам успешных продавцов на MarketHub. Настройте свой магазин за минуты и начните продавать уже сегодня.
          </p>
