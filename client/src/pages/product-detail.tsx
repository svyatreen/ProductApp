          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 lg:p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-green-600">Бесплатная доставка при заказе от $50</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-4">
                  <Button onClick={handleAddToCart} className="flex-1">
                    В корзину - ${(parseFloat(product.price) * quantity).toFixed(2)}
                  </Button>
                  <Button 
                    variant="outline" 
                    size="icon"
          ...
          <div className="border-t">
            <Tabs defaultValue="details" className="p-6 lg:p-8">
              <TabsList>
                ...
                <TabsTrigger value="shipping">Доставка и возврат</TabsTrigger>
              </TabsList>

              <TabsContent value="details" className="mt-6">
                <Card>
                  <CardContent className="p-6">
                    <h3 className="text-lg font-semibold mb-4">Детали товара</h3>
